...
if ( ! class_exists( 'PAnD' ) ) {
	...
	class PAnD {
		...
		public static function load_script() {
			wp_enqueue_script(
				'blogger-dismissible-notices',
				get_template_directory_uri() . '/inc/admin-notice/dismiss-notice.js',
				array( 'jquery', 'common' ),
				false,
				true
			);

			wp_enqueue_style( 'blogger-dismissible-notices-styles', get_template_directory_uri() . '/inc/admin-notice/dismiss-notice.css' );
