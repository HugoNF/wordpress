...
<div id="getting_started" class="certify-tab-pane active">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<h1 class="certify-info-title text-center"><?php echo __('About the Certify theme','certify'); ?><?php if( !empty($certify['Version']) ): ?> <sup id="certify-theme-version"><?php echo esc_attr( $certify['Version'] ); ?> </sup><?php endif; ?></h1>
			</div>
		</div>
		<div class="row">
			<div class="col-md-6">
			...
			<div class="col-md-6">
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
				<img src="<?php echo esc_url( get_stylesheet_directory_uri() ) . '/functions/certify-info/img/certify.png'; ?>" alt="<?php esc_html_e( 'Certify theme', 'certify' ); ?>" />
				</div>
			</div>	
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6"> 
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Lite Demo','certify'); ?></p></a>
					...
					<p class="info-text"><?php echo __('PRO Demo','certify'); ?></p></a>
			...
			<div class="col-md-6">	
				...
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Your feedback is valuable to us','certify'); ?></p></a>
					...
					<p class="info-text"><?php echo __('Premium Theme Support','certify'); ?></p></a>
				</div>
			</div>
			...
			<div class="col-md-6">	
				...
				<div class="certify-tab-pane-half certify-tab-pane-first-half">
					...
					<p class="info-text"><?php echo __('Premium Theme Details','certify'); ?></p></a>
